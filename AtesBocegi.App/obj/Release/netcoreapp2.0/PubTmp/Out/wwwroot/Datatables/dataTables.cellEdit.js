    ...
    switch (inputType) {
        case "list":
            ...
            $.each(inputSetting.options, function (index, option) {
                ...
                input.html = input.html + "<option " + selected + " value='s" + option.value + "' >s" + option.display + "</option>"
            });
        ...
        case "list-confirm": // List w/ confirm
            ...
            $.each(inputSetting.options, function (index, option) {
                selected = "";
                if (option.display == oldValue) {
                    selected = "selected";
                }
                input.html = input.html + "<option " + selected + " value='" + option.value + "' >" + option.display + "</option>"
            });
